<?php require_once 'App/Views/inc/header.php'; ?>
    <div class="row">
        <div class="col-8 mx-auto bg-white py-3 border border-dark">
            <h3>Edit Info</h3>
            <hr>
            <form action="<?php echo ROOT;?>/users/editpost/<?php echo $CarId;?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sell_model" value="<?php echo empty($model)? '' : $model;?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sell_price" class="form-control <?php echo (!empty($price_err)) ? 'is-invalid' : "";?>" value="<?php echo $price;?>">
